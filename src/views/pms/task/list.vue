...
<!--      <el-table-column label="任务号" prop="taskId"/>-->
      ...
      <el-table-column label="任务负责人" prop="taskPrincipleName"/>
      <!--      <el-table-column label="任务所在项目" prop="taskProject" />-->
      <el-table-column label="任务截止时间" prop="taskDeadline" :formatter="timeFormatter"/>
      <el-table-column label="任务详情" prop="taskDetail"/>
      <el-table-column label="任务完成时间" prop="taskFinishedTime" :formatter="timeFormatter"/>
